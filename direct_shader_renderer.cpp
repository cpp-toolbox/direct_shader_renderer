#include "direct_shader_renderer.hpp"
#include <iostream>

CW_V_TransformationWithColoredVertexDirectShaderRenderer::CW_V_TransformationWithColoredVertexDirectShaderRenderer(
...
void CW_V_TransformationWithColoredVertexDirectShaderRenderer::draw_immediate(
...
void CW_V_TransformationWithColoredVertexDirectShaderRenderer::queue_draw(const std::vector<unsigned int> &indices,
...
void CW_V_TransformationWithColoredVertexDirectShaderRenderer::draw_everything() {
